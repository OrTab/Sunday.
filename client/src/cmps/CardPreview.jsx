...
export const CardPreview = ({ idx, group, card }) => {
    ...
    const onDeleteLabel = (labelId, { labelGroup, labelType }) => {
        const label = {
            text: labelType === 'priority' ? 'Set priority' : 'No status yet',
            color: '#cccccc',
            id: Math.random()
        };
        dispatch(
                            ...
                            switch (cardOrder) {
                                ...
                                case 'status': {
                                    return (
                                        <div
                                            key={cardOrder}
                                            className="card-status card-cell"
                                        >
                                            <LabelMenu
                                                isScroll={isScroll}
                                                isLast={isLast}
                                        ...
                                        >
                                            ...
                                            >
                                                <ProgressBar
                                                    ...
                                                    startDate={
                                                        card.dueDate.startDate
                                                    }
                                                    endDate={
                                                        card.dueDate.endDate
                                                    }
                                                    status={card.status}
                                ...
                                case 'workingDays': {
                                    return (
                                        <div
                                            key={cardOrder}
                                            className="card-workingDays card-cell"
                                        >
                                            {workingDays}
                                        </div>
                                    );
                                ...
                                case 'priority': {
                                    return (
                                        <div
                                            key={cardOrder}
                                            className="card-priority card-cell"
                                        >
                                            <LabelMenu
                                                isScroll={isScroll}
                                                isLast={isLast}
